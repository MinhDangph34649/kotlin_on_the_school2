...
//                    BottomNavigationBar(navController = navController)
    ...
    private fun GetLayout (innerPadding : PaddingValues = PaddingValues(), selectedMethod : ItemThanhToan? = null, onMethodSelected: (ItemThanhToan) -> Unit) {
        ...
        listItemThanhToan.add(ItemThanhToan(color = Color("#EB8B33".toColorInt()), R.drawable.papal, "Paypal"))

        listItemThanhToan.add(ItemThanhToan(color = Color("#D93485".toColorInt()), R.drawable.momo, "Momo"))

        listItemThanhToan.add(ItemThanhToan(color = Color("#57BFF7".toColorInt()), R.drawable.zalopay, "Zalo Pay"))
...
//            GetTextTitle("Trang chu")
    ...
    @Composable
    private fun GetRowItem(color: Color, idRes: Int = R.drawable.momo, title: String = "Paypal", selected : Boolean, onSelected: () -> Unit) {
        Row(
            modifier = Modifier
                .fillMaxWidth()
    ...
    fun GetLayoutDiaChiNhanHang () {
        Column (
            ...
            Row (
                ...
                Column {
                    GetTextContent(text = "Hateco Apollo")
                    GetTextContent(text = "siuuuu")
                    GetTextContent(text = "Nam Từ Liêm")
                    GetTextContent(text = "Hà Nội")
                }
            }
